...
const SettingsScrcpy = observer(
    ({ config, setConfig }: { config: TConfig; setConfig: Dispatch<SetStateAction<TConfig>> }) => {
        ...
        return (
            <>
                <Flex direction="row" gap="2" style={{ width: "100%" }} align="center">
                    ...
                    <Button asChild color="gray" variant="soft">
                        <Link
                            href="https://github.com/Genymobile/scrcpy/blob/master/LICENSE"
                            color="gray"
                            target="_blank"
                        >
                            <Pencil1Icon />
                ...
                <Callout.Root size="1" style={{ width: "100%" }}>
                    ...
                    <Callout.Text style={{ display: "flex", flexDirection: "column", gap: "0rem" }}>
                        <Text size="2" weight="bold">
                            {t("scrcpy_useful_tip_title")}
                        </Text>
                        <Text size="1">
                            {t("scrcpy_useful_tip_description")
                                .split("\n")
                                .map((line, i) => (
                                    <>
                                        {line}
                ...
                {config.scrcpy.enable && (
                    <>
                        <SettingContainer label={t("scrcpy_log_level")} description={t("scrcpy_log_level_description")}>
                            <Select.Root
                                value={config.scrcpy.config.logLevel}
                                onValueChange={(value) => {
                                    setConfig((p) => ({
                                        ...p,
                                        scrcpy: {
                            ...
                            >
                                <Select.Trigger />
                                <Select.Content>
                                    <Select.Item value="verbose">{t("scrcpy_log_level_verbose")}</Select.Item>
                                    <Select.Item value="debug">{t("scrcpy_log_level_debug")}</Select.Item>
                                    <Select.Item value="info">{t("scrcpy_log_level_info")}</Select.Item>
                                    <Select.Item value="warn">{t("scrcpy_log_level_warn")}</Select.Item>
                                    <Select.Item value="error">{t("scrcpy_log_level_error")}</Select.Item>
                                </Select.Content>
                            </Select.Root>
                        </SettingContainer>
                        <SettingSwitch
                        ...
                        />
                        <SettingContainer
                            label={t("scrcpy_video_bitrate")}
                            description={t("scrcpy_video_bitrate_description")}
                        >
                            <TextField.Root
                            ...
                            >
                                ...
                                <TextField.Slot>
                                    <Badge color="red">{formatBitrate(config.scrcpy.config.videoBitRate ?? 0)}</Badge>
                                </TextField.Slot>
                            </TextField.Root>
                        </SettingContainer>
                        <SettingContainer
                            label={t("scrcpy_video_display_id")}
                            description={t("scrcpy_video_display_id_description")}
                        >
                            <TextField.Root
                        ...
                        <SettingContainer
                            label={t("scrcpy_video_max_size")}
                            description={t("scrcpy_video_max_size_description")}
                        >
                            <TextField.Root
                        ...
                        <SettingContainer
                            label={t("scrcpy_video_max_fps")}
                            description={t("scrcpy_video_max_fps_description")}
                        >
                            <TextField.Root
                        ...
                        {config.scrcpy.config.audio && (
                            <>
                                <SettingContainer
                                    label={t("scrcpy_audio_source")}
                                    description={t("scrcpy_audio_source_description")}
                                >
                                    <Select.Root
                                        value={config.scrcpy.config.audioSource}
                                        onValueChange={(value) => {
                                            setConfig((p) => ({
                                                ...p,
                                                scrcpy: {
                                    ...
                                    >
                                        ...
                                        <Select.Content>
                                            ...
                                            <Select.Item value="output">{t("scrcpy_audio_source_output")}</Select.Item>
                                            <Select.Item value="mic">{t("scrcpy_audio_source_mic")}</Select.Item>
                                        </Select.Content>
                                    </Select.Root>
                                </SettingContainer>
                                <SettingContainer
                                    label={t("scrcpy_audio_codec")}
                                    description={t("scrcpy_audio_codec_description")}
                                >
                                ...
                                <SettingContainer
                                    label={t("scrcpy_audio_bitrate")}
                                    description={t("scrcpy_audio_bitrate_description")}
                                >
                                    <TextField.Root

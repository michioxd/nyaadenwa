...
const Locale: LocaleResourcesType = {
    translation: {
        ...
        scrcpy: "scrcpy",
        scrcpy_settings_description: "scrcpy is an awesome open-source tool that allows you to display and control Android devices from your computer via USB or wireless connection. The scrcpy server will run on your device and forward the video stream to your browser.",
        ...
        scrcpy_video_max_size_description: "Set the maximum size of the video. Eg. the video size is 3840x2160 and max size is 2400, the size will be 2400x1350 (in pixels, default is 2400)",

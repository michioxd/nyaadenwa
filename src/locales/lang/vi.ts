...
const Locale: LocaleResourcesType = {
    translation: {
        ...
        confirm_selected_packages_enable_description: "Bạn có chắc chắn muốn bật {{count}} gói đã chọn này không?",
        all_users_need_su: "Tất cả người dùng (cần su)",
        all_users: "Tất cả người dùng",
        current_user: "Người dùng hiện tại",
        specific_user_id: "ID người dùng cụ thể",
        uninstall_selected_packages_success: "Gỡ cài đặt các gói đã chọn thành công",
        disable_selected_packages_success: "Tắt các gói đã chọn thành công",
        enable_selected_packages_success: "Bật các gói đã chọn thành công",
        error_while_performing_uninstall_selected_packages: "Đã xảy ra lỗi khi thực hiện gỡ cài đặt các gói đã chọn",
        error_while_performing_disable_selected_packages: "Đã xảy ra lỗi khi thực hiện tắt các gói đã chọn",
        error_while_performing_enable_selected_packages: "Đã xảy ra lỗi khi thực hiện bật các gói đã chọn",
        specific_user_id_label: "ID người dùng",
        specific_user_id_description: "Nhập ID người dùng để thực hiện hành động trên các gói đã chọn",
        cancelled: "Đã hủy",
        installing_apk: "Đang cài đặt APK",
        installing_files: "Đang cài đặt {{installed}}/{{total}} tệp. {{failed}} tệp không thành công",

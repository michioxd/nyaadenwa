...
const Locale: LocaleResourcesType = {
    translation: {
        ...
        scrcpy: "scrcpy",
        scrcpy_settings_description: "scrcpy là một công cụ mã nguồn mở tuyệt vời cho phép bạn hiển thị và điều khiển thiết bị Android từ máy tính của bạn thông qua kết nối USB hoặc kết nối không dây. scrcpy server sẽ chạy trên thiết bị của bạn để chiếu màn hình thiết bị lên trình duyệt.",
        ...
        scrcpy_audio_bitrate_description: "Đặt tốc độ bit âm thanh cho scrcpy (theo bits trên giây, mặc định là 128000 = 128kbps)",
        ...
        scrcpy_video_bitrate_description: "Đặt tốc độ bit video cho scrcpy (theo bits trên giây, mặc định là 10000000 = 10Mbps)",
        scrcpy_video_max_size: "Kích thước tối đa",
        scrcpy_video_max_size_description: "Đặt kích thước tối đa của video. Ví dụ: kích thước video là 3840x2160 và kích thước tối đa là 2400 thì sẽ là 2400x1350 (theo pixel, mặc định là 2400)",

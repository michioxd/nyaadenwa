...
const Locale: LocaleResourcesType = {
    translation: {
        ...
        delete_file_description: "Bạn có chắc chắn muốn xóa tệp này không?",
        delete_folder_description: "Bạn có chắc chắn muốn xóa thư mục này không?",
        failed_to_delete_file: "Không thể xóa tệp",
        failed_to_delete_folder: "Không thể xóa thư mục",
        failed_to_install_apk: "Không thể cài đặt APK",
